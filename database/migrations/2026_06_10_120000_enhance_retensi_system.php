...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('retention_policies')->insert([
            ...
            [
                'nama' => 'Default - Rawat Inap',
                'klasifikasi' => 'rawat_inap',
                'tahun_aktif' => 2,
                'tahun_inaktif' => 5,
                'alert_hari' => 30,
                'keterangan' => 'Retensi rawat inap lebih lama.',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'nama' => 'Default - Laboratorium',
                'klasifikasi' => 'lab',
                'tahun_aktif' => 1,
                'tahun_inaktif' => 2,
                'alert_hari' => 30,
                'keterangan' => 'Retensi hasil laboratorium.',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'tahun_inaktif' => 3,
                'alert_hari' => 30,
                'keterangan' => 'Kebijakan fallback jika klasifikasi tidak cocok.',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
